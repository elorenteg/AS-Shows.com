...
public class BankService implements Service {
	 ...
	 * 
	 * @param dni
	 *            DNI del comprador de l'entrada
	 * @param codiB
	 *            codi del banc del comprador
	 * @param numCompte
	 *            número de compte bancari del comprador
	 * @param preu
	 *            quantitat monetària a transferir
	 * @param codiBShows
	 *            codi del banc de l'agrupació
	 * @param numCompteShows
	 *            número de compte bancari de l'agrupació
	 * @param dAvui
	 *            data de realització de la transferencia
